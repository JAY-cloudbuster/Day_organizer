...
export const PriorityNode = ({ node }) => {
  ...
  return (
    <div className="relative w-36 h-36 rounded-full flex flex-col items-center justify-center cursor-grab active:cursor-grabbing shadow-lg"
         style={{ backgroundColor: 'rgba(251, 191, 36, 0.12)', border: '2px solid rgba(245, 158, 11, 0.4)' }}>
      {/* Outer animated ring */}
      <div className="absolute inset-0 rounded-full" 
           style={{ border: '4px solid rgba(245, 158, 11, 0.15)', animation: 'pulse 3s infinite alternate' }} />
